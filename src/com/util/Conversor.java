...
public class Conversor {
    ...
    public static void ejecute()  {
        ...
        System.out.println("-----------------------------------------------");
        System.out.println("Bienvenido/a al programa de conversor de moneda. \nPor favor elige una de las opciones");
            ...
            try {
                ...
                switch (eleccion) {
                    ...
                    case 2:
                        ...
                        try {
                            System.out.println("Ingresa el nombre de tu moneda base");
                            ...
                            if (result == null) {
                                System.out.println("Pais mal ingresado, por favor revise nuevamente el tablero");
                            } else {
                                System.out.println(result);
                                historial.add(result);
                            }
                        } catch (NumberFormatException e) {
                            System.out.println(" Error: Debes ingresar un número válido para el monto.");
                        } catch (Exception e) {
